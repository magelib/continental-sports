...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Spares'), __('Spares'));
        $resultPage->addBreadcrumb(__('Manage Spares'), __('Manage Spares'));
        $resultPage->getConfig()->getTitle()->prepend(__('Manage Spares'));
