...
class Save extends \Attercopia\Homepage_banner\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('attercopia_homepage_banner/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('attercopia_homepage_banner/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('attercopia_homepage_banner/*/new');
                }
                return;
            } catch (\Exception $e) {
